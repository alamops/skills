...
description: Analyzes a product or business from its public-facing materials (landing page, pricing, onboarding, docs, app/UI, screenshots), infers the real value proposition vs. the advertised one, generates 5–8 concrete buyer personas, ranks them across abundance / pain / urgency / willingness-to-pay / retention / strategic leverage, recommends a primary ICP plus secondary and weak-fit segments, pressure-tests positioning and pricing against likely alternatives, and proposes messaging, landing-page, onboarding, demo, and product-experience improvements. Produces project-specific Markdown artifacts under `docs/` (personas, ICP analysis, positioning recommendations, product-experience recommendations). Read-only on all source materials; prefers strategic clarity over flattery. Use whenever the user asks to analyze their business / product, generate personas, find or rank an ICP, pressure-test positioning or pricing, review their landing page or onboarding, or get a buyer-side strategic critique.
---
